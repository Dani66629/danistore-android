...
title = DaniStore - Gestor Suscripciones

# (str) Package name
package.name = gestorsuscripciones

# (str) Package domain (needed for android/ios packaging)
package.domain = com.danistore.gestor

# (str) Source code where the main.py live
source.dir = .

# (str) Main script to run
source.main = danistore_app.py
...
requirements = python3,kivy,pillow,plyer,android,pyjnius

# (str) Presplash of the application
#presplash.filename = %(source.dir)s/data/presplash.png

# (str) Icon of the application
icon.filename = iconos_android/gestor_icon.png
